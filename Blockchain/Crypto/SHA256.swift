...
public protocol Sha256Hashable {
...
extension String: Sha256Hashable {
    public var sha256: Sha256Hash { return self.data(using: .utf8)!.sha256 }
}

extension Int: Sha256Hashable {
    public var sha256: Sha256Hash { return String(self, radix: 16, uppercase: false).data(using: .utf8)!.sha256 }
}
